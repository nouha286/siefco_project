            ...
            <div class="container-fluid py-4">
                <div class="card border-0 shadow-sm overflow-auto"
                    ...
                    <div class="d-flex flex-row-reverse justify-content-between align-items-center m-4">
                        <div>
                            <select class="form-select text-center fs-5 fw-bold" id="input_select" onchange="selectClient()"
                        ...
                        <div class="input-group me-3" style="width: 25%;">
                            <input type="text" class="form-control" id="input_search" onkeyup="searchClient()"
                                    ...
                                    <td class="col-1 d-flex justify-content-between align-items-center gap-2">
                                        @if ($client->Activation == 1)
                                            <form action="{{ route('delete.Client', $client->id) }}" method="post">
                                                ...
                                                <button class="btn"
                                                    ...
                                                    type="submit"><i class="bi  bi-trash3-fill text-white"></i></button>
                                            </form>
                                            <button type="submit" class="btn btn-edit"
                                                style="background-color:var(--grey-color); color:black; border:none;"
                                        ...
                                        @if ($client->Activation == 0)
                                            <form action="{{ route('delete.Client', $client->id) }}" method="post">
                                                ...
                                                <button class="btn"
                                                    style="background-color:var(--grey-color); border:none;"
                                                    type="submit"><i class="bi bi-arrow-clockwise text-white"></i></button>
                                            </form>
                                        @endif
                                    </td>
                        ...
                        <div class="modal-content">
                            <form method="Post" action="{{ route('add.Client') }}" id="form_add_client">
                                ...
                                <div class="modal-body d-flex flex-column gap-3">
                                    ...
                                    <input type="text" name="Balance" id="blance" class="form-control "
                                        placeholder="* {{ __(' الرصيد') }}" style="height: 45px;">
                                    <div class="search_select_box w-100">
                                        <select class="selectpicker w-100" id="devise" name="devise"
                                    ...
                                    <input type="text" name="Password_verif" id="add_conf_password"
                        ...
                        <div class="modal-content">
                            <form method="Post" action="{{ route('add.Client') }}" id="form_edit_client">
                                ...
                                <div class="modal-body  d-flex flex-column gap-4 ">
                                    ...
                                    <input type="text" class="First_Name" id="edit_first_name" name="First_Name"
                                        class="form- " placeholder="*{{ __('الاسم') }}">
                                    <input type="text" class="Last_Name" id="edit_last_name" name="Last_Name"
                                        class="form-control " placeholder="*{{ __('النسب') }}">
                                    <input type="text"class="Email" id="edit_email" name="Email"
                                        class="form-control " placeholder="* {{ __('البريد الالكتروني') }}">
                                    <input type="text" class="Phone" id="edit_phone" name="Phone"
                                        class="form-control " placeholder="* {{ __('رقم الهاتف') }}">
                                    <input type="text" class="Balance" id="edit_blance" name="Balance"
                                        class="form-control " placeholder="* {{ __(' الرصيد') }}" style="height: 45px;">
                                    <div class="search_select_box w-100">
                                        <select class="selectpicker w-100 devise" id="edite_devise" name="devise"
                                            data-live-search="true">
