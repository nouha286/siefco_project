                        ...
                        <thead>
                            <tr>
                                @if (session('role') == 'Admin')
                                    <th></th>
                                @endif
                                <th class="col-3 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">رقم
                                    الهاتف</th>
                                <th class="col-3 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">البريد
                                    الالكتروني</th>
                                <th class="col-3 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">النسب
                                </th>
                                <th class="col-3 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">الاسم
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                                        ...
                                        @if (session('role') == 'Admin')
                                            <td class="col-1 d-flex  gap-3">
                                                <form action="{{ route('delete.Admin', $Admin->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn" style="border:none; background-color:white;"
                                        ...
                                        <form method="Post" action="{{ route('add.Admin') }}">
                                            ...
                                            <div class="modal-body d-flex flex-column gap-4">
                                                ...
                                                <input type="text" class="First_Name" name="First_Name"
                                                    class="form- mb-3" placeholder="*الاسم">
                                                <input type="text" class="Last_Name" name="Last_Name"
                                                    class="form-control mb-3" placeholder="*النسب">
                                                <input type="text" class="Email" name="Email"
                                                    class="form-control mb-3" placeholder="*البريد الالكتروني">
                                                <input type="text" class="Phone" name="Phone"
                                                    class="form-control mb-3" placeholder="*رقم الهاتف">
                                                <input type="hidden" name="edit_add" class="form-control"
                                                    value="2">
                                            </div>
                                        ...
                                        <tr class="mx-2">
                                            <td class="col-1 ">
                                                <form action="{{ route('delete.Admin', $Admin->id) }}" method="post">
                                                    ...
                                                    @method('DELETE')
                                                    <button class="btn" style="border:none; background-color:white;"
                                                        type="submit"><i class="bi bi-arrow-clockwise"></i> </button>
                                                </form>
                                            </td>
