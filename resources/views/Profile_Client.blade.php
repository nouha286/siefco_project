        ...
        <div class="col-3 position-relative" id="assidBar">
            <aside class="d-flex flex-column align-items-center" id="assidbar"
                ...
                <div class="d-flex flex-column justify-content-center align-items-center py-5 gap-4">
                    ...
                    <a href="interface_client" class="text-center border-0 list-group-item list-group-item-action">
        ...
        <div class="position-relative w-100">
            ...
            <div class="container shadow-lg p-3 mb-5  py-4">
                <div class="card border-1 shadow-sm overflow-auto" style="  border-radius: 16px;">
                    ...
                    @endif
                    <form class="d-flex flex-column gap-1 m-5" method="POST" action="{{ route('editClient') }}"
                        enctype="multipart/form-data" id="form_signup">
                        @csrf
                        <div class="mb-3">
                            <input class="form-control border-1 border-primary form-control-lg" name="image"
