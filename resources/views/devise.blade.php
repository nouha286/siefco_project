            ...
            <div class="container-fluid py-4">
                <div class="card border-0 shadow-sm overflow-auto"
                    ...
                    <div class="d-flex flex-row-reverse justify-content-between align-items-center m-4">
                        <div>
                            <select class="form-select text-center fs-5 fw-bold" id="input_select" onchange="selectDevise()"
                        ...
                        <div class="input-group me-3" style="width: 25%;">
                            <input type="text" class="form-control" id="input_search" onkeyup="searchDevise()"
                                    ...
                                    <form method="Post" action="{{ route('add.devise') }}">
                                        ...
                                        <div class="modal-body d-flex flex-column gap-4">
                                            <input type="text" name="Name" class="form-control"
                                                placeholder="*{{ __('العملة') }}" style="height: 45px;">
                                            <input type="text" name="Value" class="form-control"
                                                placeholder="* {{ __('القيمة مقابل الدولار') }}" style="height: 45px;">
                                        </div>
                    ...
                    <table class="table mb-0 text-center" id="table_devise">
                        <thead>
                            <tr>
                                <th class="col-2"></th>
                                <th class="d-none"></th>
                                <th class="col-5 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    {{ __('القيمة مقابل الدولار') }}</th>
                                <th class="col-5 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    {{ __('الاسم') }}</th>
                                <th class="d-none"></th>
                            </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="Post" action="{{ route('add.devise') }}" id="form_add_devise">
                            ...
                            <div class="modal-body d-flex flex-column gap-4">
                                <input type="text" class="name_devise" id="add_devise_name" name="Name"
                                    class="form-control mb-2" placeholder="*{{ __('العملة') }}" style="height: 45px;">
                                <input type="text" class="value_devise" id="add_devise_value" name="Value"
                                    class="form-control" placeholder="*{{ __('القيمة مقابل الدولار') }}"
                                    style="height: 45px;">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                    ...
                    <div class="modal-content">
                        <form method="Post" action="{{ route('add.devise') }}">
                            ...
                            <div class="modal-body d-flex flex-column gap-4">
                                ...
                                <input type="text" class="name_devise" name="Name" class="form-control mb-2"
                                    placeholder="*{{ __('العملة') }}" style="height: 45px;">
                                <input type="text" class="value_devise" name="Value" class="form-control"
                                    placeholder="*{{ __('القيمة مقابل الدولار') }}" style="height: 45px;">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
