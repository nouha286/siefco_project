                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-1 d-flex gap-2">
                                ...
                                <button type="submit" class="btn update" style="background-color:white; color:black; border:none;" data-bs-toggle="modal" data-bs-target="#exampleModaledit"><i class="bi bi-pen-fill"></i></button>
                                ...
                                <div class="modal-content">
                                    <form method="Post" action="{{ route('add.Employe') }}">
                                        ...
                                        <div class="modal-body  ">
                                            <input type="text" name="First_Name" class="form-control mb-3" placeholder="*الاسم" style="height: 45px;">
                                            <input type="text" name="Last_Name" class="form-control mb-3" placeholder="*النسب" style="height: 45px;">
                                            <input type="email" name="Email" class="form-control mb-3" placeholder="*البريد الالكتروني" style="height: 45px;">
                                            <input type="text" name="Phone" class="form-control mb-3" placeholder="*رقم الهاتف" style="height: 45px;">
                                            <input type="text" name="Password" class="form-control " placeholder="*القن السري" style="height: 45px;">
...
<script>
    ...
    $("#myTable").on('click','.update',function(){
        ...
        $('#First_Nama').val(colmatricul);
        $('#Last_Name').val(colname);
        $('#Email').val(colprenom);
        $('#Phone').val(colpwd);
